...
def upgrade() -> None:
    ...
    transactiontype = postgresql.ENUM(
        "Order", "Payment_Cash", "Payment_Check", "Check_Return",
        name="transactiontype",
    )
    transactionstatus = postgresql.ENUM(
        "Pending", "Deposited", "Returned", "Cleared",
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("Admin", "Designer", "Sales", name="userrole"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("is_discounted", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("assigned_day", sa.Enum("Sun", "Mon", "Tue", "Wed", "Thu", name="assignedday"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_by", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("type", sa.Enum("Order", "Payment_Cash", "Payment_Check", "Check_Return", name="transactiontype"), nullable=False),
        sa.Column("currency", sa.Enum("ILS", "USD", "JOD", name="currency"), nullable=False, server_default="ILS"),
        sa.Column("amount", sa.Numeric(12, 2), nullable=False),
        sa.Column("status", sa.Enum("Pending", "Deposited", "Returned", "Cleared", name="transactionstatus"), nullable=True),
        sa.Column("related_transaction_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("transactions.id"), nullable=True),
