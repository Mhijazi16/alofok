...
- [ ] **Phase 6: Check Data Foundation** - Expand check schema to full typed model, extend the payment form with bank/branch/account/holder fields
- [ ] **Phase 7: SVG Check Preview** - Live LTR bank check preview that mirrors a real check and updates as the user types
...
|-------|-----------|----------------|--------|-----------|
| 6. Check Data Foundation | 1/2 | In Progress|  | - |
