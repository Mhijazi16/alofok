...
- [x] **STMT-02**: User can export the current statement view as a PDF document
- [x] **STMT-03**: PDF supports Arabic text and RTL layout
...
| STMT-02 | Phase 15 | Complete |
| STMT-03 | Phase 15 | Complete |
