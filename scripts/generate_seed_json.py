...
MANUAL_GROUPS = {
    "فرشاية دهان Agron": {"numbers": [1, 2, 3, 4, 5, 6, 7], "category": "فراشي", "trademark": "Agron"},
    "فرشاية Crown ابيض": {"numbers": [13, 14, 15, 16, 17, 18], "category": "فراشي", "trademark": "Crown"},
    "فرشاية Painto ازرق": {"numbers": [21, 22, 23, 24, 25, 26], "category": "فراشي", "trademark": "Painto"},
    "فرشاية Super Agron": {"numbers": [27, 28, 29, 30, 31], "category": "فراشي", "trademark": "Super Agron"},
    "فرشاية Max": {"numbers": [335, 336, 337, 338, 339, 340], "category": "فراشي", "trademark": "Max"},
    "فرشاية قلم": {"numbers": [32, 33, 34, 35, 36, 37, 500], "category": "فراشي", "trademark": "Agron"},
    "فرشاية Agron العلبة الصفراء": {"numbers": [10, 11, 12, 230, 231], "category": "فراشي", "trademark": "Agron"},
    "فرشاية Agron الاصلي": {"numbers": [251, 252, 253], "category": "فراشي", "trademark": "Agron"},
    "فرشاية بلوفا": {"numbers": [385, 386, 387, 388, 406, 407, 453], "category": "فراشي", "trademark": "بلوفا"},
    "فرشاية تيرا": {"numbers": [19, 20, 115, 116], "category": "فراشي", "trademark": "تيرا"},
    "فرشاية معكوفه": {"numbers": [39, 40, 41, 42], "category": "فراشي", "trademark": ""},
    ...
    "طقم رولات": {"numbers": [54, 55, 56, 57, 58, 493], "category": "رولات", "trademark": ""},
    "يد رول": {"numbers": [181, 182], "category": "رولات", "trademark": ""},
    "رول تركي DOGRU": {"numbers": [260, 262, 334], "category": "رولات", "trademark": "DOGRU"},
    "مجراد عادي": {"numbers": [508, 132, 133, 134, 135, 136, 185, 186], "category": "مجاريد", "trademark": ""},
    "مجراد هايد": {"numbers": [272, 273, 274, 275, 276, 277, 278], "category": "مجاريد", "trademark": "هايد"},
    "مجراد هايد copy": {"numbers": [436, 437, 438, 439, 440, 441, 448], "category": "مجاريد", "trademark": "هايد"},
    "مجراد هايد Master كعب حديد": {"numbers": [496, 497, 498], "category": "مجاريد", "trademark": "Master Hyde"},
    "مجراد ستانلس": {"numbers": [404, 405], "category": "مجاريد", "trademark": ""},
    "سكتش عادي": {"numbers": [202, 203, 204, 205, 211, 212, 221, 222, 239, 246, 248], "category": "ورق حف", "trademark": ""},
    "سكتش 4.5\"": {"numbers": [247, 366], "category": "ورق حف", "trademark": ""},
    "ورق اسفنج عادي": {"numbers": [207, 208, 209, 210, 234, 296], "category": "ورق حف", "trademark": ""},
    "ورق اسفنج سيا": {"numbers": [256, 257, 258, 259, 361, 367], "category": "ورق حف", "trademark": "سيا"},
    "نورتن اسفنج": {"numbers": [311, 312, 313, 315, 316], "category": "ورق حف", "trademark": "نورتن"},
    "ورق حف رول تمساح اسود": {"numbers": [269, 270, 271, 341, 343, 344, 345, 346], "category": "ورق حف", "trademark": "تمساح"},
    "ورق حف رول تمساح احمر": {"numbers": [284, 285, 292, 347, 348, 349, 350], "category": "ورق حف", "trademark": "تمساح"},
    "ورق حف رول كتان": {"numbers": [263, 264, 266], "category": "ورق حف", "trademark": ""},
    "تيب سم": {"numbers": [171, 173, 172, 452], "category": "تيب", "trademark": ""},
    "تيب 5سم": {"numbers": [175, 368, 198, 199, 219, 177, 486], "category": "تيب", "trademark": ""},
    "تيب عريض شفاف": {"numbers": [176, 310, 377, 449], "category": "تيب", "trademark": ""},
    "زاوية جبص": {"numbers": [168, 331], "category": "زوايا", "trademark": ""},
    "زاوية U": {"numbers": [303, 420], "category": "زوايا", "trademark": ""},
    "ستانسل Painto": {"numbers": [160, 161, 163, 158], "category": "ستانسل", "trademark": "Painto"},
    "عصا": {"numbers": [148, 149, 150, 151, 152, 153, 154], "category": "عصي", "trademark": ""},
    "ورق جبص": {"numbers": [169, 170, 288], "category": "ورق جبص", "trademark": "يوتا"},
    "فتحة صيانه": {"numbers": [462, 463, 464, 465, 466, 479, 480, 481, 495], "category": "فتحات صيانه", "trademark": ""},
    "مالج ملتينه Level5": {"numbers": [473, 474, 475, 476], "category": "موالج", "trademark": "Level5"},
    "نصلة Level5": {"numbers": [487, 488, 489, 490], "category": "موالج", "trademark": "Level5"},
    "فرد سلكون": {"numbers": [319, 330, 320, 369, 468], "category": "ادوات", "trademark": ""},
    "كمامة": {"numbers": [88, 314, 206, 235, 236, 355, 354, 353, 381], "category": "حماية", "trademark": ""},
    "كباية اسود": {"numbers": [391, 392, 393], "category": "كبايات", "trademark": ""},
    "كباية ازرق": {"numbers": [394, 395], "category": "كبايات", "trademark": ""},
    "براغي جبص": {"numbers": [245, 254, 432, 429, 471], "category": "براغي", "trademark": ""},
    ...
    "سبري ATC": {"numbers": [309, 447, 450, 451], "category": "سبري", "trademark": "ATC"},
    ...
    "جلدة لازور": {"numbers": [103, 104, 105, 108, 224], "category": "جلود", "trademark": ""},
    "مالج Enox": {"numbers": [140, 141], "category": "موالج", "trademark": "Enox"},
    "رول 9\" ماركات": {"numbers": [65, 66, 67, 68, 80], "category": "رولات", "trademark": ""},
    "سوبر جلو": {"numbers": [289, 290], "category": "لواصق", "trademark": ""},
    "مطبة كابرس": {"numbers": [118, 119, 156, 184], "category": "ديكور", "trademark": "كابرس"},
...
def main():
    ...
    print(f"Generated {len(products)} products ({sum(1 for p in products if p['options'])} grouped, {sum(1 for p in products if not p['options'])} standalone)")
